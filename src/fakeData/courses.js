var courses = [
  ...
  },
  {
    ...
    details:
      'Walkthroughs on advanced React v16.6.3 and Redux v4.0.0 - Authentication, Testing, Middlewares, HOC',
    auth: 'Mosh',
    price: 11.9,
    img: 'reactRedux.png',
  },
  ...
  },
  {
    ...
    details:
      'An advanced JavaScript course for everyone! Scope, closures, prototypes, build your own framework, and more.',
    auth: 'Anthony Alica',
    price: 14.9,
